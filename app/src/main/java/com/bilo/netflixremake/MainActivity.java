...
import com.bilo.netflixremake.model.Category;
import com.bilo.netflixremake.model.Movie;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class MovieHolder extends RecyclerView.ViewHolder {
        ...
        private final ImageView imageViewUrl;

        public MovieHolder(@NonNull View itemView) {
            super(itemView);
            imageViewUrl = itemView.findViewById(R.id.iv_cover);
        }
    }
    ...
    //Gerencia os itens dinâmicos e atribui um Layout customizado através de um ViewHolder
